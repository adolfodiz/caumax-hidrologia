...
MDT25_PATH = os.path.join(DATA_FOLDER, "MDT25_peninsula_UTM30N.tif")
CORINE_VISU_PATH = os.path.join(DATA_FOLDER, "CORINE_VISU.tif")
CN_HIDRO_PATH = os.path.join(DATA_FOLDER, "CN_hidrologico.tif")
